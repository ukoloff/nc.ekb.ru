...
global $CFG;
$CFG->oClasses=Array(
    'u'=>Array('name'=>'User', 'attrs'=>Array('sAMAccountName', 'userAccountControl', 'msSFU30NisDomain')),
...
//    echo "<Center>", $x->t, "</Center>\n";
	...
	$CFG->oIcons[$x->t]['file'], '.gif" Alt="', $CFG->oIcons[$x->t]['title'], '"></Center>';
    break;
   case 'f':
