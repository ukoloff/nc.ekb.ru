...
if ($e['manager'][0]):
  ...
  echo utf2html($em['displayname'][0]), 
    ...
    '" title="Открыть карточку"><i class="fa fa-external-link"></i></a><span class="^c"/>';
endif;
?></td></tr>
<?
...
<TR><TH NoWrap>Электронная почта</TH><TD><?
 ...
 if($e['mail']['count']) echo "<!--<a href='mailto:", utf2html($e['mail'][0]), "' Title='Послать почту'><i class='fa fa-envelope-o'></i></a>--><span class='^c'/>";
?><BR /></TD></TR>
<TR><TH>Lync</TH><TD><?
$sip=utf2html($e['msrtcsip-primaryuseraddress'][0]);
echo preg_replace('/^sip:/i', '', $sip);
if(strlen($sip)) echo '<!--<a href="', $sip, '" Title="Послать мгновенное сообщение"><i class="fa fa-commenting-o"></i></a>--><span class="^c"/>';
?><BR /></TD></TR>
<tr><th>SID</th><td>
