...
foreach(Array('disable', 'dontExpire', 'nis', 'limit', 'free', 'notify') as $p)
...
function disableNotify()
{
 ...
 $H['X-Sent-From']='http'.($_SERVER['HTTPS']?'s':'')."://".$CFG->u.'@'.$_SERVER['SERVER_NAME'];
