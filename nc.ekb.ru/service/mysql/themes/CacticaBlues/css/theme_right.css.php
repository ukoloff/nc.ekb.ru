...
th{
    ...
    background-image:    url(../themes/CacticaBlues/img/tbl_th.png);
...
*/
    background-image: url(../themes/CacticaBlues/img/s_warn.png);
...
<?php if ($cfg['ErrorIconic'] && isset($js_isDOM) && $js_isDOM != '0') { ?>
*/
    background-image: url(../themes/CacticaBlues/img/s_error.png);
    background-repeat: no-repeat;
...
.tblHeaders{
    ...
    <?php if (isset($js_isDOM) && $js_isDOM != '0') { ?>
    background-image:    url(../themes/CacticaBlues/img/tbl_header.png);
    background-repeat:   repeat-x;
    background-position: top;
    <?php } ?>
    height:              18px;
...
.tblHeadError {
    ...
    background-color:    #cc0000;
    <?php if (isset($js_isDOM) && $js_isDOM != '0') { ?>
    background-image:    url(../themes/CacticaBlues/img/tbl_error.png);
    background-repeat:   repeat-x;
    background-position: top;
    <?php } ?>
    height:              18px;
...
.serverinfo div{
    background-image:    url(../themes/CacticaBlues/img/item_ltr.png);
    background-repeat:   no-repeat;
