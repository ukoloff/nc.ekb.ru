...
$cfg['Servers'][$i]['password']      = 'AsUgAtE';          // MySQL password (only needed
...
$cfg['Servers'][$i]['AllowDeny']['rules']           // Host authentication rules, leave blank for defaults
                                     = array();
$cfg['Servers'][$i]['pmadb']         = 'phpadmin';          // Database used for Relation, Bookmark and PDF Features
                                                    // - leave blank for no support
